...
def get_hyper_params(data):
    ...
    hyper_params = {'g': {'mu': validation_pickle['g'], 'cov': 1000*ones(n)}, # iid normal prior
                    ...
                    'transition_var_g': {'a': 1001, 'b': validation_pickle['transition_var_g']*1000, 'max': 1}, # inv-gamma prior - mean = true val
                    'transition_var_h': {'a': 1001, 'b': validation_pickle['transition_var_h']*1000, 'max': 5}} # inv-gamma prior - mean = true val
    return hyper_params
