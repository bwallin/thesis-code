...
def get_hyper_params(data):
    ...
    hyper_params = {'g': {'mu': validation_pickle['g'], 'cov': 1000*ones(n)}, # iid normal prior
                    ...
                    'noise_proportion': {'alpha': array((100, 100))}, # dirichlet prior
                    'transition_var_g': {'a': 101, 'b': validation_pickle['transition_var_g']*100, 'max': 1}, # inv-gamma prior - mean = true val
                    'transition_var_h': {'a': 101, 'b': validation_pickle['transition_var_h']*100, 'max': 5}} # inv-gamma prior - mean = true val
    return hyper_params
